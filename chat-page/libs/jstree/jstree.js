...
(function (factory) {
	...
	$.jstree.core.prototype = {
		...
		_append_json_data : function (dom, data, cb, force_processing) {
			...
			if(this.settings.core.worker && window.Blob && false && window.URL && window.Worker) {
				try {
					if(this._wrk === null) {
						this._wrk = func;
		...
		create_node : function (par, node, pos, callback, is_loaded) {
			...
			if(!node) { node = { "text" : this.get_string('new_node') }; }
			if(typeof node === "string") { node = { "text" : node }; }
			if(node.text === undefined) { node.text = this.get_string('new_node'); }
			var tmp, dpc, i, j;
