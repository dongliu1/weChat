...
if(window.$ || window.jQuery){
    ...
    $(function () {
        ...
        var navTop = jqOb('#navWrap').offset().top;
        var scrollFun = function (e) {
            var scrollTop = $(this).scrollTop();
            if (scrollTop > navTop - 20) {
                jqOb('#navWrap').addClass('fixed');
            } else {
                jqOb('#navWrap').removeClass('fixed');
            }
        }
        ...
        //trigger scrollSpy refresh after 3 seconds
        setTimeout(function(){
            $body.scrollspy('refresh');
        },3000);
    });
    ...
    //style fancy button
    $('.btn[data-fancy-btn]').each(function () {
        $.single(this).append('<span class="lines top"></span><span class="lines right"></span><span class="lines bottom"></span><span class="lines left"></span>')
    });
